...
public class Server {
    ...
    public static String localhost = "192.168.0.135";
    ...
    public static String DuongDanSuaSanPham = "http://"  + localhost + "/ServerSmartShop/Main/sua_QL_SanPham.php";
    public static String DuongDanXoaSanPham = "http://"  + localhost + "/ServerSmartShop/Main/xoa_QL_SanPham.php";

    public static String DuongDanGetUsers = "http://"  + localhost + "/ServerSmartShop/Main/get_users.php";
    public static String DuongDanThemUser = "http://"  + localhost + "/ServerSmartShop/Main/them_user.php";
    public static String DuongDanSuaUser = "http://"  + localhost + "/ServerSmartShop/Main/sua_user.php";
    public static String DuongDanXoaUser = "http://"  + localhost + "/ServerSmartShop/Main/xoa_user.php";

    public static String DuongDanGetDonHang = "http://"  + localhost + "/ServerSmartShop/Main/get_donhang.php";
    public static String DuongDanThemDonHang = "http://"  + localhost + "/ServerSmartShop/Main/them_donhang.php";
    public static String DuongDanSuaDonHang = "http://"  + localhost + "/ServerSmartShop/Main/sua_donhang.php";
    public static String DuongDanXoaDonHang = "http://"  + localhost + "/ServerSmartShop/Main/xoa_donhang.php";

    public static String DuongDanGetChiTietDonHang = "http://"  + localhost + "/ServerSmartShop/Main/get_chitietdonhang.php";
